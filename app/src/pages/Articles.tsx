...
const articles = [
  ...
  {
    id: 3,
    title: 'مكانة ميثم التمار among أصحاب الإمام علي',
    excerpt: 'كان ميثم التمار من أقرب أصحاب الإمام علي بن أبي طالب إليه، وقد أخذ عنه علوماً كثيرة في تفسير القرآن...',
    date: '2025-03-15',
    author: 'الشيخ علي الكربلائي',
    category: 'virtues',
    tags: ['أصحاب الإمام علي', 'المنزلة', 'الفضائل'],
    readTime: '7 دقائق',
  },
  {
    id: 4,
